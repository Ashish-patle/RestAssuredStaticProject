...
import Post_ReqRepository.post_req_repository;
...
public class Post_TC_1 {
	...
	public static void execute() throws IOException
	{
		...
		int statusCode = API_Common_Function.statusCode(post_req_repository.baseURI(),post_req_repository.resource(),post_req_repository.requestBody());
		if(statusCode==201) {
		System.out.println("status code is " +statusCode);
		
		
		String responseBody =  API_Common_Function.responseBody(post_req_repository.baseURI(),post_req_repository.resource(),post_req_repository.requestBody());
		Post_TC_1.validator(responseBody, statusCode);
		Utility_Common_Function.evidencefilecreater("Ashu",post_req_repository.requestBody() , responseBody);
	...
	System.out.println(post_req_repository.requestBody());
		//parse the req and res body
		JsonPath jspr = new JsonPath(post_req_repository.requestBody());
